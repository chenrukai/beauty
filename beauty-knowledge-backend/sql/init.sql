...
(
    id             BIGINT       NOT NULL AUTO_INCREMENT COMMENT '��ϵID',
    product_id     BIGINT       NOT NULL COMMENT '��ƷID',
    effect_id      BIGINT       NOT NULL COMMENT '��ЧID',
    confidence     DECIMAL(5,2)          DEFAULT 0.78 COMMENT '���Ŷ�',
    source         VARCHAR(100)          DEFAULT 'manual' COMMENT '��Դ',
    status         VARCHAR(20)  NOT NULL DEFAULT 'ACTIVE' COMMENT 'ACTIVE/INACTIVE',
    evidence_count INT          NOT NULL DEFAULT 0 COMMENT '֤������',
    created_at     DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at     DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (id),
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='��Ʒ��Ч��ϵ��';
